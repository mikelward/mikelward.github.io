...
abstract class BaseStorePeer {
	...
	const CLASS_KEY = 'stores.CLASS_KEY';

	/** A key representing a particular subclass */
	const CLASSKEY_1 = '1';

	/** A key representing a particular subclass */
	const CLASSKEY_JBHIFIONLINE = '1';

	/** A class that can be returned by this peer. */
	const CLASSNAME_1 = 'library.JBHiFiOnline';

	/** A key representing a particular subclass */
	const CLASSKEY_2 = '2';

	/** A key representing a particular subclass */
	const CLASSKEY_ATLANTICDVD = '2';

	/** A class that can be returned by this peer. */
	const CLASSNAME_2 = 'library.AtlanticDVD';

	/** A key representing a particular subclass */
	const CLASSKEY_3 = '3';

	/** A key representing a particular subclass */
	const CLASSKEY_AMAZON = '3';

	/** A class that can be returned by this peer. */
	const CLASSNAME_3 = 'library.Amazon';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('StoreId', 'Name', 'CountryId', 'HomepageUrl', 'ClassKey', ),
		BasePeer::TYPE_COLNAME => array (StorePeer::STORE_ID, StorePeer::NAME, StorePeer::COUNTRY_ID, StorePeer::HOMEPAGE_URL, StorePeer::CLASS_KEY, ),
		BasePeer::TYPE_FIELDNAME => array ('store_id', 'name', 'country_id', 'homepage_url', 'class_key', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('StoreId' => 0, 'Name' => 1, 'CountryId' => 2, 'HomepageUrl' => 3, 'ClassKey' => 4, ),
		BasePeer::TYPE_COLNAME => array (StorePeer::STORE_ID => 0, StorePeer::NAME => 1, StorePeer::COUNTRY_ID => 2, StorePeer::HOMEPAGE_URL => 3, StorePeer::CLASS_KEY => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('store_id' => 0, 'name' => 1, 'country_id' => 2, 'homepage_url' => 3, 'class_key' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(StorePeer::CLASS_KEY);
	...
	public static function populateObjects(ResultSet $rs)
	{
		...
		while($rs->next()) {
			...
			$cls = Propel::import(StorePeer::getOMClass($rs, 1));
			$obj = new $cls();
			$obj->hydrate($rs);
			$results[] = $obj;
	...
	public static function doSelectJoinCountry(Criteria $c, $con = null)
	{
		...
		while($rs->next()) {
			...
			$omClass = StorePeer::getOMClass($rs, 1);
