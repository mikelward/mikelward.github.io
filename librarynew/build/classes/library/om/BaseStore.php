...
abstract class BaseStore extends BaseObject  implements Persistent {
	...
	public function setClassKey($v)
	{
		...
		if ($this->class_key !== $v) {
			$this->class_key = $v;
			$this->modifiedColumns[] = StorePeer::CLASS_KEY;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->class_key = $rs->getInt($startcol + 4);
			...
			return $startcol + 5; // 5 = StorePeer::NUM_COLUMNS - StorePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(StorePeer::CLASS_KEY)) $criteria->add(StorePeer::CLASS_KEY, $this->class_key);
		...
		if ($this->collStoreItems === null) {
			if ($this->isNew()) {
			   $this->collStoreItems = array();
				...
				$criteria->add(StoreItemPeer::STORE_ID, $this->getStoreId());
	 ...
	 */
	public function getStoreItemsJoinItem($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'library/om/BaseStoreItemPeer.php';
		if ($criteria === null) {
		...
		if ($this->collStoreItems === null) {
			if ($this->isNew()) {
				...
				$this->collStoreItems = StoreItemPeer::doSelectJoinItem($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
