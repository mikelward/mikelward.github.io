...
<head>
<title>Mac Shortcuts Firefox Addon</title>
...
<div id="content">
    <div class="summary">
    <p>
        Adds some Mac keyboard shortcuts to the Windows version of Firefox.
    </p>
    </div>
    <div class="description">
        <table>
            <tr class="heading"><th>Shortcut</th><th>Command</th></tr>
            <tr><td class="shortcut">Ctrl+Q</td><td class="command">Quit</td></tr>
            <tr><td class="shortcut">Ctrl+,</td><td class="command">Options</td></tr>
        </table>
    </div>
    <div class="download">
    <p>
        <a href="mac-shortcuts-0.5.2.xpi">Install Mac Shortcuts 0.5.2</a>
    </p>
    </div>
    <div class="notes">
    <p class="note">
