...
// actual class may be a subclass -- as returned by CountryPeer::getOMClass()
include_once 'library/Country.php';
...
abstract class BaseCountryPeer {
	...
	const CLASS_DEFAULT = 'library.Country';
	...
	const COUNTRY_ID = 'countries.COUNTRY_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('CountryId', 'Name', 'Code', ),
		BasePeer::TYPE_COLNAME => array (CountryPeer::COUNTRY_ID, CountryPeer::NAME, CountryPeer::CODE, ),
		BasePeer::TYPE_FIELDNAME => array ('country_id', 'name', 'code', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('CountryId' => 0, 'Name' => 1, 'Code' => 2, ),
		BasePeer::TYPE_COLNAME => array (CountryPeer::COUNTRY_ID => 0, CountryPeer::NAME => 1, CountryPeer::CODE => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('country_id' => 0, 'name' => 1, 'code' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		include_once 'library/map/CountryMapBuilder.php';
		return BasePeer::getMapBuilder('library.map.CountryMapBuilder');
	}
	/**
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CountryPeer::COUNTRY_ID);
	...
	const COUNT = 'COUNT(countries.COUNTRY_ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT countries.COUNTRY_ID)';
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(CountryPeer::COUNTRY_ID); // remove pkey col since this table uses auto-increment
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(CountryPeer::COUNTRY_ID);
			$selectCriteria->add(CountryPeer::COUNTRY_ID, $criteria->remove(CountryPeer::COUNTRY_ID), $comparison);
	...
	/**
	 * Method to DELETE all rows from the countries table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(CountryPeer::COUNTRY_ID, (array) $values, Criteria::IN);
		}
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(CountryPeer::COUNTRY_ID, $pk);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(CountryPeer::COUNTRY_ID, $pks, Criteria::IN);
...
if (Propel::isInit()) {
	...
	require_once 'library/map/CountryMapBuilder.php';
	Propel::registerMapBuilder('library.map.CountryMapBuilder');
}
