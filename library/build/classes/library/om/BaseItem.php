...
abstract class BaseItem extends BaseObject  implements Persistent {
	...
	public function setAsin($v)
	{
		...
		if ($this->asin !== $v) {
			$this->asin = $v;
			$this->modifiedColumns[] = ItemPeer::ASIN;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->asin = $rs->getString($startcol + 6);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ItemPeer::ASIN)) $criteria->add(ItemPeer::ASIN, $this->asin);
		...
		if ($this->collStoreItemss === null) {
			if ($this->isNew()) {
			   $this->collStoreItemss = array();
				...
				$criteria->add(StoreItemsPeer::ITEM_ID, $this->getItemId());
	 ...
	 * actually need in Item.
	 */
	public function getStoreItemssJoinStore($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'library/om/BaseStoreItemsPeer.php';
		if ($criteria === null) {
		...
		if ($this->collStoreItemss === null) {
			if ($this->isNew()) {
				...
				$this->collStoreItemss = StoreItemsPeer::doSelectJoinStore($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
